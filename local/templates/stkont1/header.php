...
<body>
    ...
    <header class="header">
        <div class="container -flex -just-btw -center">
            <div class="header__side logo-side -flex -center">
                ...
                <a href="<?=($city->url!='')?'/'.$city->url:'/'?>" class="logo"><img src="<?=SITE_TEMPLATE_PATH?>/img/logo.svg" alt=""></a>
                <div class="header__description">Продажа и обслуживание складской техники<a class="city" href="<?=($city->url!='')?'/'.$city->url:''?>/filials"><?=(isset($city->other_title))?' '.$city->other_title."</a> и&nbsp;":''?>по&nbsp;всей&nbsp;России
                </div>
            </div>
            <div class="header__side -flex -center">
                ...
                <div class="header__contacts">
                    ...
                    <div class="header__geo"><a href="<?=($city->url!='')?'/'.$city->url:''?>/filials">Сменить филиал</a></div>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="second-menu-scroll">
            ...
            <div class="second-menu__city__content">
                <div class="second-menu__city">
                    <div>Ваш город: <span><?=$city->title?></span></div><a href="<?=($city->url!='')?'/'.$city->url:''?>/filials">Выбрать другой</a>
                </div>
            </div>
            <ul class="second-menu-lvl-1">
                <li>
                    <a class="<?=($url_segment == 'index')?'active':''?>" href="/<?=$city->url?>">Главная</a>
                </li>
                ...
                <li>
                    ...
                    <ul class="second-menu-lvl-2">
                        ...
                        <!--                    <li>-->
                        <!--                        <a class="--><?//=($url_segment_brand == 'liugong')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong#sub-categories">LiuGong</a>-->
                        <!--                        <ul class="second-menu-lvl-3">-->
                        <!--                            <li>-->
                        <!--                                <a class="--><?//=($url_segment_brand == 'liugong/pogruzchiki')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/pogruzchiki#sub-categories">Погрузчики LiuGong </a>-->
                        <!--                                <ul class="second-menu-lvl-4">-->
                        <!--                                    <li><a class="--><?//=($url_segment_brand == 'liugong/dizel-pogruzchiki')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/dizel-pogruzchiki#products">Дизельные погрузчики LiuGong</a></li>-->
                        <!--                                    <li><a class="--><?//=($url_segment_brand == 'liugong/benz-pogruzchiki')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/benz-pogruzchiki#products">Бензиновые погрузчики LiuGong</a></li>-->
                        <!--                                    <li><a class="--><?//=($url_segment_brand == 'liugong/elektropogruzchiki')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/elektropogruzchiki#products">Электрические погрузчики LiuGong</a></li>-->
                        <!--                                </ul>-->
                        <!--                            </li>-->
                        <!--                            <li>-->
                        <!--                                <a class="--><?//=($url_segment_brand == 'liugong/shtabelery')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/shtabelery#sub-categories">Штабелеры LiuGong </a>-->
                        <!--                                <ul class="second-menu-lvl-4">-->
                        <!--                                    <li><a class="--><?//=($url_segment_brand == 'liugong/shtabelery-samohodnye')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/shtabelery-samohodnye#products">Самоходные штабелеры LiuGong</a></li>-->
                        <!--                                </ul>-->
                        <!--                            </li>-->
                        <!--                            <li><a class="--><?//=($url_segment_brand == 'liugong/rohli')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/rohli#sub-categories">Рохли LiuGong </a>-->
                        <!--                                <ul class="second-menu-lvl-4">-->
                        <!--                                    <li><a class="--><?//=($url_segment_brand == 'liugong/gidravlicheskie-telezhki')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/gidravlicheskie-telezhki#products">Гидравлические тележки LiuGong</a></li>-->
                        <!--                                    <li><a class="--><?//=($url_segment_brand == 'liugong/elektrotelezhki')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/elektrotelezhki#products">Электророхли LiuGong</a></li>-->
                        <!--                                </ul>-->
                        <!--                            </li>-->
                        <!--                            <li><a class="--><?//=($url_segment_brand == 'liugong/richtraki')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/liugong/richtraki#products">Ричтраки LiuGong </a></li>-->
                        <!--                        </ul>-->
                        <!--                    </li>-->
                        <li>
    ...
    <!--                            <li><a class="--><?//=($url_segment_brand == 'hc/rohli')?'active':''?><!--" href="--><?//=($city->url!='')?'/'.$city->url:''?><!--/b/hc/rohli#products">Рохли HC</a></li>-->
                ...
                <li>
                    <a class="<?=($url_segment == 'lizing')?'active':''?>" href="<?=($city->url!='')?'/'.$city->url:''?>/lizing">Техника в лизинг</a>
                </li>
                <li>
                    <a class="<?=($url_segment == 'clients')?'active':''?>" href="<?=($city->url!='')?'/'.$city->url:''?>/clients">Наши клиенты</a>
                </li>
                <li>
                    <a class="<?=($url_segment == 'parts')?'active':''?>" href="<?=($city->url!='')?'/'.$city->url:''?>/parts">Запчасти</a>
                </li>
                <li>
                    <a class="<?=($url_segment == 'contacts')?'active':''?>" href="<?=($city->url!='')?'/'.$city->url:''?>/contacts">Контакты</a>
                </li>
                <li>
